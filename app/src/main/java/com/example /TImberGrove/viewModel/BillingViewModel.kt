...
class BillingViewModel @Inject constructor(
    ...
    private val _address = MutableStateFlow<Resource<List<AddressInfo>>>(Resource.Unspecified())
    ...
    fun getUserAddress(){
        ...
        firestore
            ...
            .addSnapshotListener{ value, error ->
                ...
                val addressInfo = value?.toObjects(AddressInfo::class.java)
                viewModelScope.launch { _address.emit(Resource.Success(addressInfo!!)) }
            }
    }
